 ...
 *
 * Adds a fully expanded version of the main menu to the page template and it
 * calls it $primary_nav.
 *
 * @param array $variables
 */
function hcpss_schoolsite_theme_preprocess_page(&$variables) {
  // Primary nav.
